...
* [About The QR code](#about-the-qr-code)
  * [version](#version)
...
## About the QR code
A QR code is a machine-readable matrix barcode and it stands for “quick response” code.You can use the camera app on any phone to scan a QR code.
It can store the data of about 4kb. 
...
square) and are equal to `4 * version + 17`. To get more information on size refer [Data Capacities](#data-capacities)
...
the QR code to be damaged or unreadable. The level of Error correction supported are listed below
...
* Arguments
 ...
 ## Bitmap
 The bitmap is the type of image formating like png, jpeg etc..
 In embedded systems to display the QR code on the displays like Oled , led, we need to have the bitmap array of the
 qrcode. To get the bitmap array we used this function:-
...
## Acknowledgement 
* [nayuki](https://github.com/nayuki) for qrcode library
